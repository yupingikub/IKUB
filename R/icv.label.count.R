...
#' control group, other participants or patients.
#' NIfTI-files.
...
#' example, the list(0,0,0) means common segmentations, list(1,1,1) represents
#' background plus MR segmentations and list(1,0,1) is class 1 and class 3 in
#' the tissue segmentations plus MR segmentations.
