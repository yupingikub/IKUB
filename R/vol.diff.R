...
#' @description Compares the normalized volumes and none normalized volumes 
#' for individuals.
...
#' ninth column has column name icv_mm3 with numeric format. We recommend 
#' that you use icv.label.count() to generate input data. 
