...
#' We recommend that you use regr.coeff() to generate input data.
...
#' ninth column has column name icv_mm3 with numeric format. We recommend that 
#' you use icv.label.count() to generate input data. 
